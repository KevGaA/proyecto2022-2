...
public class Dibujo extends javax.swing.JFrame {
    ...
    private void palabraKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_palabraKeyReleased
        ...
        for (int i = 0; i < text.length(); i++) {
            ...
            if (x<1100){
                if (Negrita == true){
                    g2d.setStroke(new BasicStroke(1.6f));//se enchanza en trazo para evitar letras incompletas
                }
                if (Puntos == true) {
                ...
                if("l".equals(letra)){//listo
                    ...
                    if (Subr == true){
                        curve.moveTo(0+x, 70+y);
                        curve.curveTo(25+x, 65+y, 25+x, 20+y, 20+x,10+y);
    ...
    public Path2D.Double Dletras(String letra, int x, int y){
        ...
        g2d.setColor(Color.BLACK);        
        jPanel1.update(g2d);
        //para que funcione hay que sacar las lineas y agregar al final de la clase g2d.draw(curve) ,pero solo las dibujara 1 vez y luego desaparecera
            if ("a".equals(letra)){//listo
                curve.moveTo(0+x, 70+y);
            ...
            if (x<1100){
                ...
                if("...".equals(letra)){
                    ...
                    if (Puntos==true) {
                        ...
                        g3d.fillOval(15+x, 65+y, 4, 4);
                        g3d.fillOval(12+x, 67+y, 4, 4);
                        g3d.fillOval(12+x, 68+y, 4, 4);
                        g3d.fillOval(15+x, 70+y, 4, 4);
                        g3d.fillOval(17+x, 68+y, 4, 4);
                        g3d.fillOval(17+x, 67+y, 4, 4);
                        g3d.fillOval(15+x, 65+y, 4, 4);
                        
                        g3d.fillOval(25+x, 65+y, 4, 4);
                        g3d.fillOval(22+x, 67+y, 4, 4);
                        g3d.fillOval(22+x, 68+y, 4, 4);
                        g3d.fillOval(25+x, 70+y, 4, 4);
                        g3d.fillOval(27+x, 68+y, 4, 4);
                        g3d.fillOval(27+x, 67+y, 4, 4);
                        g3d.fillOval(25+x, 65+y, 4, 4);
                    }
