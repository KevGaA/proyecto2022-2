...
public class Dibujo extends javax.swing.JFrame {
            ...
            for (int k = 0; k < textSeparado[i].length(); k++) {
                ...
                if (x < 1100) {
                    ...
                    if ("z".equals(letra)) {
                        ...
                        if (Negrita == true && Curs == true && Subr == true) {
                            DibujoFinal.add(Dcursivas(letra, x, y, T));
                        }
                        if (Negrita == true) {
                            if (Curs == false && Subr == false) {
    ...
    public Path2D.Double Dcursivas(String letra, int x, int y, double T) {
        ...
        if("y".equals(letra)){
            ...
            curve.curveTo((00+x)*T, (100+y)*T,( 30+x)*T, (80+y)*T, (60+x)*T, (70+y)*T);
        }
        if("z".equals(letra)){
            curve.moveTo((0+x)*T, (70+y)*T);
    ...
    public Graphics2D Pcontrol(String letra, int x, int y, double T) {
